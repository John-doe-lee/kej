    ...
    <aside class="user-left">
     <div class="usermenus">
      <ul class="usermenu">
       ...
       <li class="active"><a href="<?php echo url('user/buy'); ?>"><i class="iconfont"></i>积分管理</a></li>      
     ...
     <div class="user_contentr">
      ...
      <div class="settin">
       <div class="header_tips">
        <i class="iconfont"></i>您目前可用积分： <?php echo $obj['user_points']; ?>
       </div>
