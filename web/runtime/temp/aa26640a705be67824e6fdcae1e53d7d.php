...
<ul class="menu_slide" nav-data="nav_273609">
 ...
 <div class="fl">
   <div class="fl_title">
    <div class="fl01">
      搜索结果：<?php echo $__PAGING__['record_total']; ?>
    </div>
   </div>
   <div class="filter-wrap">
    <div class="filter-tag">
     <div class="fl_list">
      ...
      共找到“<strong style="color:#4c8fe8" class="mac_total"></strong>”篇关于“<strong style="color:#4c8fe8;"><?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?></strong>”的内容</span>
     </div>
    </div>
   </div>
  </div>
