<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"template/hdbee_bak/html/user/reg.html";i:1544256676;s:54:"/var/www/html/template/hdbee_bak/html/public/head.html";i:1544284764;s:54:"/var/www/html/template/hdbee_bak/html/public/foot.html";i:1544256662;}*/ ?>
<!DOCTYPE html>
<html>
 <head>
  <meta charset="UTF-8" />
...
<link type="text/css" media="all" href="<?php echo $maccms['path_tpl']; ?>css/user.css" rel="stylesheet"/>
  ...
  <div class="reg_main">
   <div class="reg_inner">
    <div class="reg_inner_header">
     ...
     <div class="rih_left2" onclick="window.location.href='<?php echo mac_url('user/login'); ?>'">
       登 录
     </div>   	
     ...
     <div class="reg_mid_left">
      <div class="reg_form">
        ...
        <div class="form-group has-feedback"> 
         <input type="text" class="form-control" id="user_name" name="user_name" placeholder="用户名" value="" data-fv-field="username" /> 
         <i class="fa fa-user"></i>
        </div>
        <div class="kong10"></div>
      
        <div class="form-group has-feedback"> 
         <input type="password" class="form-control" name="user_pwd" placeholder="密码(6位以上)" id="user_pwd" data-fv-field="pass" /> 
         <i class="fa fa-key"></i>
        </div>
        <div class="kong10"></div>
        <div class="form-group has-feedback"> 
         <input type="password" class="form-control" name="user_pwd2" placeholder="重复密码" id="user_pwd2" data-fv-field="pass" /> 
         <i class="fa fa-key"></i>
        </div>
		...
		<input type="text" class="forr" id="verify" name="verify" placeholder="请输入验证码">
           ...
           <i class="fa fa-key"></i>
         <img  style="float: right;position: inherit;top: -36px;" id="verify_img" src="<?php echo url('verify/index'); ?>" onClick="this.src=this.src+'?'"  alt="单击刷新" />
        </div>
        ...
        <input type="button" id="btn_submit" class="login_btn" value="立即注册">
       </form>
      </div>
      <div class="other_login" style="padding-top:25px">
       ...
       <div class="other_login_action">
        <a class="qq_btn" href="<?php echo url('user/oauth'); ?>?type=qq"><i class="iconfont"></i>QQ 登录</a>
       </div>
      </div>
     </div>
