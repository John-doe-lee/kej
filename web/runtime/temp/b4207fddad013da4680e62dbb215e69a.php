...
<a class="fl_link<?php if($param['area'] == ''): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>'','lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>">不限</a>
  <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5cacbe8911b94=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5cacbe8911b94) || $_5cacbe8911b94 instanceof \think\Collection || $_5cacbe8911b94 instanceof \think\Paginator): if( count($_5cacbe8911b94)==0 ) : echo "" ;else: foreach($_5cacbe8911b94 as $key2=>$vo2): ?>
    ...
    <?php endforeach; endif; else: echo "" ;endif; else: $_5cacbe89114ce=explode(',',$obj['type_extend']['area']); if(is_array($_5cacbe89114ce) || $_5cacbe89114ce instanceof \think\Collection || $_5cacbe89114ce instanceof \think\Paginator): if( count($_5cacbe89114ce)==0 ) : echo "" ;else: foreach($_5cacbe89114ce as $key2=>$vo2): ?>
    <a class="fl_link<?php if($param['area'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$vo2,'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
  ...
  <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5cacbe890fddf=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5cacbe890fddf) || $_5cacbe890fddf instanceof \think\Collection || $_5cacbe890fddf instanceof \think\Paginator): if( count($_5cacbe890fddf)==0 ) : echo "" ;else: foreach($_5cacbe890fddf as $key2=>$vo2): ?>
  ...
  <?php endforeach; endif; else: echo "" ;endif; else: $_5cacbe890fd2a=explode(',',$obj['type_extend']['class']); if(is_array($_5cacbe890fd2a) || $_5cacbe890fd2a instanceof \think\Collection || $_5cacbe890fd2a instanceof \think\Paginator): if( count($_5cacbe890fd2a)==0 ) : echo "" ;else: foreach($_5cacbe890fd2a as $key2=>$vo2): ?>
 <a class="fl_link<?php if($param['class'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$vo2,'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; endif; ?>
      ...
      <div class="fl_list">
       <span>影视年代:</span>
                ...
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5cacbe890fc8d=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5cacbe890fc8d) || $_5cacbe890fc8d instanceof \think\Collection || $_5cacbe890fc8d instanceof \think\Paginator): if( count($_5cacbe890fc8d)==0 ) : echo "" ;else: foreach($_5cacbe890fc8d as $key2=>$vo2): ?>
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5cacbe890fbdd=explode(',',$obj['type_extend']['year']); if(is_array($_5cacbe890fbdd) || $_5cacbe890fbdd instanceof \think\Collection || $_5cacbe890fbdd instanceof \think\Paginator): if( count($_5cacbe890fbdd)==0 ) : echo "" ;else: foreach($_5cacbe890fbdd as $key2=>$vo2): ?>
                   <a class="fl_link<?php if($param['year'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo2,'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; endif; ?>
    ...
    <ul class="update_area_lists cl" id="index_ajax_list">
     <?php $__TAG__ = '{"num":"24","paging":"yes","pageurl":"vod\/show","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
      ...
      <div class="user_list_kz_meta">
       ...
       <div class="otherinfo">
        类型：
	<?php $_5cacbe890faee=explode(',',$vo['vod_class']); if(is_array($_5cacbe890faee) || $_5cacbe890faee instanceof \think\Collection || $_5cacbe890faee instanceof \think\Paginator): if( count($_5cacbe890faee)==0 ) : echo "" ;else: foreach($_5cacbe890faee as $key2=>$vo2): ?>
