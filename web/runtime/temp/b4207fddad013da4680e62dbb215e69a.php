...
<a class="fl_link<?php if($param['area'] == ''): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>'','lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>">不限</a>
  <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5caff38a92a9e=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5caff38a92a9e) || $_5caff38a92a9e instanceof \think\Collection || $_5caff38a92a9e instanceof \think\Paginator): if( count($_5caff38a92a9e)==0 ) : echo "" ;else: foreach($_5caff38a92a9e as $key2=>$vo2): ?>
    <a class="fl_link<?php if($param['area'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$vo2,'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
    <?php endforeach; endif; else: echo "" ;endif; else: $_5caff38a929fb=explode(',',$obj['type_extend']['area']); if(is_array($_5caff38a929fb) || $_5caff38a929fb instanceof \think\Collection || $_5caff38a929fb instanceof \think\Paginator): if( count($_5caff38a929fb)==0 ) : echo "" ;else: foreach($_5caff38a929fb as $key2=>$vo2): ?>
    <a class="fl_link<?php if($param['area'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$vo2,'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
    <?php endforeach; endif; else: echo "" ;endif; endif; ?>
      ...
      <div class="fl_list">
       <span>影视类型:</span>
  <a class="fl_link<?php if($param['class'] == ''): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>'','order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>">不限</a>
  <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5caff38a92940=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5caff38a92940) || $_5caff38a92940 instanceof \think\Collection || $_5caff38a92940 instanceof \think\Paginator): if( count($_5caff38a92940)==0 ) : echo "" ;else: foreach($_5caff38a92940 as $key2=>$vo2): ?>
  <a class="fl_link<?php if($param['class'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$vo2,'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; else: $_5caff38a9289b=explode(',',$obj['type_extend']['class']); if(is_array($_5caff38a9289b) || $_5caff38a9289b instanceof \think\Collection || $_5caff38a9289b instanceof \think\Paginator): if( count($_5caff38a9289b)==0 ) : echo "" ;else: foreach($_5caff38a9289b as $key2=>$vo2): ?>
 <a class="fl_link<?php if($param['class'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$vo2,'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; endif; ?>
      ...
      <div class="fl_list">
       <span>影视年代:</span>
                ...
                <a class="fl_link<?php if($param['year'] == ''): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>'','level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>">不限</a>
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5caff38a927db=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5caff38a927db) || $_5caff38a927db instanceof \think\Collection || $_5caff38a927db instanceof \think\Paginator): if( count($_5caff38a927db)==0 ) : echo "" ;else: foreach($_5caff38a927db as $key2=>$vo2): ?>
                    <a  class="fl_link<?php if($param['year'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo2,'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5caff38a92736=explode(',',$obj['type_extend']['year']); if(is_array($_5caff38a92736) || $_5caff38a92736 instanceof \think\Collection || $_5caff38a92736 instanceof \think\Paginator): if( count($_5caff38a92736)==0 ) : echo "" ;else: foreach($_5caff38a92736 as $key2=>$vo2): ?>
                   <a class="fl_link<?php if($param['year'] == $vo2): ?> tag-linked <?php endif; ?>" href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo2,'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; endif; ?>
  ...
  <div class="update_area">
   ...
   <div class="update_area_content">
    <ul class="update_area_lists cl" id="index_ajax_list">
     <?php $__TAG__ = '{"num":"24","paging":"yes","pageurl":"vod\/show","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
      ...
      <div class="user_list_kz_meta">
       ...
       <div class="otherinfo">
        类型：
	<?php $_5caff38a9266a=explode(',',$vo['vod_class']); if(is_array($_5caff38a9266a) || $_5caff38a9266a instanceof \think\Collection || $_5caff38a9266a instanceof \think\Paginator): if( count($_5caff38a9266a)==0 ) : echo "" ;else: foreach($_5caff38a9266a as $key2=>$vo2): ?>
