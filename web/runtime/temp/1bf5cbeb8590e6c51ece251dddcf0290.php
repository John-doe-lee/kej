   ...
   <div class="user_tab_botting">
    <div class="setting_inner">
     ...
     <div class="user_setting_num">
      <p><span>收藏</span><em> p</em></p>
      <p><span>积分</span><em><?php echo $obj['user_points']; ?></em></p>
      <p><span>推广</span><em>0</em></p>
     </div>
    </div>
   </div>
     ...
     <div class="user_contentr">
      ...
      <div class="settin">
       ...
       <div class="header_tips">
       		<ul>
					<li><a href="<?php echo url('user/orders'); ?>">在线充值记录</li>
					<li class="cur">充值卡记录</li>
			</ul>
...
<?php else: ?>      
		<table width="870" border="0" cellspacing="1" cellpadding="0" class="table">
		  ...
		  <tr>
			<td height="36" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ids[]" type="checkbox" value="<?php echo $vo['card_id']; ?>"></td>
			<td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $vo['card_id']; ?></td>
			<td align="left" valign="middle" bgcolor="#FFFFFF" class="pad"><?php echo $vo['card_no']; ?></td>
			<td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $vo['card_money']; ?></td>
			  <td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $vo['card_points']; ?></td>
			  <td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo mac_day($vo['card_use_time']); ?></td>
